...
//WiFi & MQTT 
const char* ssid = "Lowi14BD";
const char* password = "SSLN3B6HGDDJTD";
// const char* ssid = "HwS";
// const char* password = "moreno9733";
const char* mqtt_server = "josemiguel.myqnapcloud.com";
...
unsigned long StackHighWaterMark_interval = 1000UL;
...
bool first_scan_flow_measurement = true;
